...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function () {
    return (
    React.createElement("div", {className: "small-12 medium-6 large-4 columns"}, 
      React.createElement("div", {id: this.getId(), className: "sound"}, 
        React.createElement("div", {className: "options"}, 
          React.createElement("i", {className: "fa fa-close delete", "data-audio-id": this.props.sound.audioId})
        ), 
        React.createElement("h3", {className: "sound-name"},  this.props.sound.name), 
        React.createElement("audio", {id: this.props.sound.audioId, src: this.props.sound.path, preload: "auto"}), 
        React.createElement("div", {className: "controls"}, 
            React.createElement("i", {className: (!this.state.playing)?'fa fa-play play':'fa fa-pause play paused', "data-audio-id": this.props.sound.audioId}), 
            React.createElement("i", {className: (!this.state.stopped)?'fa fa-stop stop':'fa fa-stop stop stopped', "data-audio-id": this.props.sound.audioId}), 
            React.createElement("i", {className: (!this.state.loop)?'fa fa-repeat repeat':'fa fa-repeat repeat repeating', "data-audio-id": this.props.sound.audioId})
        )
      )
    )
    )
  ...
  render: function () {
    ...
    React.createElement("div", {className: "row"}, 
      this.props.row.map(function(sound) {
        return React.createElement(Sound, {key: sound.id, sound: sound})
      })
    )
    )
  }
...
},{"./Sound.jsx":157,"react":156}],159:[function(require,module,exports){
// soundboard.jsx
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {id: "soundboard"}, 
        rows.map(function (row, index) {
            return React.createElement(SoundRow, {key: index, row: row});
        })
      )
    );
  },
...
},{"./Sound.jsx":157,"./SoundRow.jsx":158,"react":156}],160:[function(require,module,exports){
// App.jsx
...
},{"./Soundboard.jsx":159,"react":156}]},{},[160]);
